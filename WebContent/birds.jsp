 	...
 	<div class="container">
 		<div class="row">
 				...
 				<div class="col-md-8"><!-- right -->
 					<h2 style="text-align: center;">Birds</h2><br>
					...
					<input type="submit" value="Go!">
 					...
 					<c:forEach items="${list }" var="product">
 						...
 						<c:if test="${product.getCategory() == 'birds' }">
		 					...
		 					<div class="col-md-4">
								...
								<div class="text-center">  <a class="btn btn-primary" href="Controller?page=addtocart&quantity=<c:out value="${product.getQUANTITY()}"/>&action=home-decor&id=<c:out value="${product.getId()}"/>">Add to Cart</a> </div><br>		 					</div>
