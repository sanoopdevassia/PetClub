...
<body>
		...
		<nav>
			...
			<ul>
				...
				<li class="nav-item active"><a class="nav-link" href="main.jsp"
					data-blast="color">Home <span class="sr-only">(current)</span></a>
				</li>
				...
				<c:choose>
					...
					<c:when test="${session != null}">
						<li class="nav-item"><a class="nav-link"
							href="Controller?page=order">Orders</a></li>
						<li class="nav-item"><a class="nav-link"
							href="Controller?page=logout" style="color: #F24638;">Logout</a></li>
						<li class="nav-item"><a class="nav-link" href="#">My
								Account(<c:out value="${username }"></c:out>)
						</a></li>
					</c:when>
				</c:choose>
				<li class="nav-item"><a class="nav-link"
					href="Controller?page=showcart">cart(<c:out value="${x}" />)
				</a></li>
			</ul>
				...
				<div class="col-md-4">
					...
					<div class="list-group">
						...
						<a href="Controller?page=all-products" class="list-group-item"
							style="background: #00a8e0;"> <font color="white">All
								Products</font>
						</a> <a href="Controller?page=mobiles" class="list-group-item">Fish</a>
				...
				<div class="col-md-8">
					...
					<form action="Controller" method="get"
						...
						<input type="hidden" name="page" value="price-sort"> <input
							type="hidden" name="action" value="index"> <select
							name="sort">
						...
						<c:if test="${product.getFeatured() == 'yes' }">
							...
							<div class="col-md-4">
								...
								<div class="text-center">
									...
									<c:out
											value="${product.getQUANTITY() }"></c:out> Items Left</a>
								</div>
								...
								<div class="text-center">
									<a class="btn btn-primary"
										href="Controller?page=addtocart&quantity=<c:out value="${product.getQUANTITY()}"/>&action=index&id=<c:out value="${product.getId()}"/>">Add
										to Cart</a>
								</div>
								<br>
							</div>
	...
	<footer>
		<div class="footer">
			&copy; 2020 Copyright: <a href="Controller?page=index">
				Petclub.com</a>
		</div>
	</footer>
